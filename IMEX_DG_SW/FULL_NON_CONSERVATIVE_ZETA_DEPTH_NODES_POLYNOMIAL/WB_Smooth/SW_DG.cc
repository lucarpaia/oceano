...
protected:
  ...
  LinearAlgebra::distributed::Vector<double> zb;
...
void SWSolver<dim>::setup_dofs() {
  ...
  matrix_free_storage->initialize_dof_vector(zb, 0);
...
void SWSolver<dim>::initialize() {
  ...
  VectorTools::interpolate(mapping, dof_handler_elevation, zb_exact, zb);
