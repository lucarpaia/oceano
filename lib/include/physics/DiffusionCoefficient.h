...
namespace Physics
{
  ...
  // at which coastal models operates, will be mainly an eddy diffusivity.
  // In coastal flows, transport brings closer water masses with different
  // properties, building up strong gradients. These can be simulated with
  // TVD schemes or with an horizontal "eddy" diffusion. The next class
  // and its derived classes, basically compute the eddy diffusivity. 
